    ...
    >
      <div>
        <div style={{ ...styles.row }}>
          ...
          <h3 style={{ ...FONTS.body7, width: 150, margin: "0px 0px 0px 5px" }}>
            {homeName}
          </h3>
        ...
        {isUser ? (
          <div style={{ ...styles.row }}>
            {isUser?.profileImage ? (
              <img src={isUser?.profileImage} width={20} />
            ) : (
              <FaUserCircle />
            )}
      ...
      <h3 style={{ ...FONTS.h5, color: isWin === isUser?._id ? COLORS.green : !isWin ? COLORS.gray  : COLORS.red}}>
