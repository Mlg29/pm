        ...
        <div className="top-container" style={{ ...styles.container }}>
            <div style={{ display: "flex", flexDirection: "column", flex: 3 }}>
                ...
                <div style={{ marginTop: 20, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", flex: 1 }}>
                    ...
                    <div>
                        <h3 style={{ ...FONTS.h4, fontWeight: '600', textAlign: 'center', margin: "10px 0px" }}>Bet Place</h3>
                        <p style={{ ...FONTS.body6, textAlign: 'center', fontWeight: '400' }}>Hurray! You have successfully place a bet from your account.</p>
                    </div>
                </div>
            </div>
