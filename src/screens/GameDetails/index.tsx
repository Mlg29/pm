...
function GameDetails() {
  ...
  const handleRoute = (route: string) => {
    ...
    if (token) {
      ...
      const payload = {
        userType:
          (route === gameInfo?.localTeamName || route === gameInfo?.player[0]['@name'])
            ? "W1"
            : (route === gameInfo?.visitorTeamName || route === gameInfo?.player[1]['@name'])
            ? "W2"
            : "DRAW",
              ...
              <div style={{ ...styles.mob }}>
                <div style={{ width: "100%" }}>
                  <Button
                    ...
                    handlePress={() => handleRoute(gameInfo?.player[0]["@name"])}
                  />
                </div>
                <div style={{ width: "100%", margin: "10px 0px" }}>
                  <Button
                    ...
                    // handlePress={() => navigate('/home')}
                    handlePress={() => handleRoute(gameInfo?.player[1]["@name"])}
                  />
                </div>
              </div>
            ) : (
